...
def trace_parse(input_string):
    ...
    while stack:
        ...
        # If top of stack is terminal but doesn't match input → error
            ...
            print(
                f"{step:<5} {str(stack):<30} {current_input:<20} Error: Unexpected terminal '{top}'"
            )
            success = False
            break
        ...
        # If top is non-terminal, look up production rule
            ...
            if production:
                ...
                print(
                    f"{step:<5} {str(stack):<30} {current_input:<20} Error: No rule for {top} with '{current_char}'"
                )
                success = False
                break
        ...
        # Invalid character in stack (not terminal or non-terminal)
            ...
            print(
                f"{step:<5} {str(stack):<30} {current_input:<20} Error: Invalid symbol '{top}'"
            )
            success = False
            break
